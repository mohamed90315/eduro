...
class _RankCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    switch (rank) {
      case 1:
        bgColor = Colors.amber.shade300; // gold
        break;
      case 2:
        bgColor = Colors.grey.shade300; // silver
        break;
      case 3:
        bgColor = Colors.brown.shade300; // bronze
        break;
      default:
    ...
    return Container(
      ...
      padding: const EdgeInsets.all(17), // slightly thicker padding
      decoration: BoxDecoration(
        color: bgColor,
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
        ...
        boxShadow: [
          BoxShadow(
            color: Colors.black.withValues(alpha: 0.09), // fixed
            blurRadius: 1,
            spreadRadius: 1,
            offset: const Offset(0, 1),
          ),
          BoxShadow(
            color: Colors.cyanAccent.withValues(alpha: 0.2), // fixed cyan glow
            blurRadius: 1,
            spreadRadius: 1,
            offset: const Offset(0, 1),
          ),
