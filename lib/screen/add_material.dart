    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          (_pickedFiles.isNotEmpty || _pickedAudios.isNotEmpty || _pickedVideos.isNotEmpty)
            ...
            child: Column(
              ...
              children: [
                ...
                if (_pickedVideos.isNotEmpty) ...[
                  ...
                  const SizedBox(height: 8),
                  ..._pickedVideos.asMap().entries.map((entry) {
                    final index = entry.key;
                    ...
                    return Container(
                      ...
                      child: ListTile(
                        dense: true,
                        leading: const Icon(Icons.video_file, color: Color(0xFF2A7DE1)),
                        title: Text(
                          video.name,
                          overflow: TextOverflow.ellipsis,
                          style: const TextStyle(fontSize: 14),
