...
class _AddMaterialPageState extends State<AddMaterialPage>
  ...
  void _saveNote() async {
    ...
    _showSnackBar(context, "Material saved successfully ✅");
  }
  ...
  void _recordVoiceNote() {
    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
        content: Text("Recording voice note... (placeholder) 🎤")));
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          /// Scrollable content (dropdown + cards)
          Expanded(
          ...
          (_pickedFiles.isNotEmpty || _pickedAudios.isNotEmpty)
              ? _buildCard(
            fade: _fade1,
            slide: _slide1,
            child: Column(
              ...
              children: [
                ...
                if (_pickedAudios.isNotEmpty) ...[
                  ...
                  const SizedBox(height: 8),
                  ..._pickedAudios.asMap().entries.map((entry) {
                    final index = entry.key;
                    ...
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(10),
                        border: Border.all(
                          color: const Color(0xFF2BD46E).withOpacity(0.3),
                        ),
                        color: Colors.grey.shade50,
                      ),
                      child: ListTile(
                        ...
                        trailing: IconButton(
                          icon: const Icon(Icons.close, color: Colors.red),
                          onPressed: () {
                            setState(() => _pickedAudios.removeAt(index));
                          },
                        ),
                      ),
                    );
